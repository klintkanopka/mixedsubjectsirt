...
- **`tune_lambda_ability_risk()`** returns the $\lambda$ that minimises the *propagated
...
can choose the method, and always pair with `tune_lambda_ability_risk` or
`tune_lambda_ability_risk_crossfit` for final lambda selection. The power-tuning step is
