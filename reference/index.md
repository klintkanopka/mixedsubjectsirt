...
- [`fit_mixed_subjects_iterative()`](http://klintkanopka.com/mixedsubjectsirt/reference/fit_mixed_subjects_iterative.md)
...
- [`ability_gradient_1pl()`](http://klintkanopka.com/mixedsubjectsirt/reference/ability_gradient_1pl.md)
...
- [`ability_risk_1pl()`](http://klintkanopka.com/mixedsubjectsirt/reference/ability_risk_1pl.md)
...
- [`simulate_2pl()`](http://klintkanopka.com/mixedsubjectsirt/reference/simulate_2pl.md)
...
- [`mixed_subjects_loss()`](http://klintkanopka.com/mixedsubjectsirt/reference/mixed_subjects_loss.md)
